...
class Test5 {
	...
	public Test5(String name, int age) {
		...
		this.name = name;
		this.age = age;
//		The static field Test5.count should be accessed in a static way
...
//	이클립스에서 final 요소는 볼드체(굵게)가 적용된다
	...
	public static void main(String[] args) {
		...
		Test5 ob1 = new Test5("전준우", 37);
		Test5 ob2 = new Test5("안권수", 28);
		
		System.out.println("Test5 타입의 객체 수 :" +Test5.getCount());
		
//		ob1.setCount(1);  settrer가 없어서 private 필드의 값을 수정할 수 없다
...
//		non-statric 필드는 객체마다 서로 다른값을 저장하지만
