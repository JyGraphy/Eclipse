...
public class Ex06 {
	...
	public static void main(String[] args) {
		...
		// Scanner 의 함수별 기능과 특징
		
		// sc.next() 문자열을 입력 받는다. 띄어쓰기 및 줄바꿈이 있으면 그 앞까지만 가져온다
		// sc.nextInt() 정수를 입력받는다. 아스키 코드 48 ~ 57 범위의 연속된 값만 가져온다
		// sc.nextDouble() 실수를 입력받는다. 48 ~ 57및 '.' 글자 하나까지만 입력받는다
		...
		// 문자열형식으로 입력받고 (엔터기는 정리되고) 문자열 내용을 숫자형식으로 변경하여 저장한다
