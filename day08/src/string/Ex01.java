...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.equals(str2));			// 내용이 일치하는지 확인
		
		// 같은 내용의 글자라도, 비교연산자로는 true가 나오지 않는다
		// 참조 주소 일치 확인
		System.out.println(str == str2);				// 참조하는 주소가 같은지 확인
