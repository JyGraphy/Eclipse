...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		short sh = 32767;
		char ch = 44032;
		long ln = 30000000000L;	//기본자료형이 아니기 때문에 long임을 명시
		float fl = 1.2f;		//기본자료형이 아니기 때문에 float임을 명시
		double db = 3.14;
		
		
		//The value of the local variable by is not used
		//지역 변수 bo는 아직 한번도 상용되지 않았습니다
		//변수는 나중에 값을 다시 사용하기 위해서 만드는 건데, 왜 한번도 안썻지?
