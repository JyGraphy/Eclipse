...
//		참고) 컬렉션의 제네릭 타입에는 primitive type를 지정할 수 없다
...
//		오름차순(정렬에서 순서를 지정하지 않았을때의 기본값)
		...
		System.out.println();
//		내림차순 정렬하기
//		1) 인터페이스는 추상클래스의 일종이므로, 익명클래스 방식의 객체 생성이 가능
		...
		System.out.println("list1 :  " + list1);
		System.out.println();
//		2) Comparator<T>는 함수형 인터페이스이므로, 람다식 객체 생성이 가능하다
