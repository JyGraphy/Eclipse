...
//		static 메서드 getRuntime()을 이용해서 하난의 런타임만 참조할 수 있도록 되어있다
//		특정 클래스의 객체가 오직 하나만 생성되고, 하나의 객체만 참조할 수 있는 패턴을 싱글톤 패턴
