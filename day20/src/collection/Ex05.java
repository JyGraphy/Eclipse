...
//		List<E>와 마찬가지로 Set도 인터페이스다
//		Set을 구현한 HashSet<E>클래스를 사용한다
		
		HashSet<String> set = new HashSet<>();
		System.out.println("set.size() : " + set.size());
		
		set.add("apple");	// 동인한 내용을 두번 추가했으나 중복을 허용하지 않아서 추가되지 않는다
		set.add("banana");
		set.add("apple");
...
//		이미 만들ㅇ진 컬렉션을 다른 컬렉션의 생성자에 전달하면 요소를 유지하면서 새로운 컬렉션을 생성
