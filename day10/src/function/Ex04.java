...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		// 오버로딩된 함수를 호출할떄는 값만 넣으면 알아서 맞는 정의를 찾아간다
		...
		// 함수 오버호딩의 기준은 매개변수의 개수 및 자료형, 혹은 매개변수의 순서
		// 반환 자료형은 오버로딩에 전혀 영향을 줄 수 없다
...
//	static double add(String n1, String n2) {			// 첫번쨰 add와 반환형이 다르지만
